...
This document is alive, contains mistakes and will change over time.
I need to kinda do this practice a lot to understand it better and define the container better :)
